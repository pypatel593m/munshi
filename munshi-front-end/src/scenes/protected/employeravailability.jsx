...
const EmployerAvailability = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await Axios.post(
          `${process.env.REACT_APP_API_URL}/getemployeravailabilities`,
          {
    ...
    fetchData();
  }, [NextWeekClick, PreviousWeekClick, business.m_business_id]);
  ...
  function AvailableTime(props) {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          await Axios.post(
            `${process.env.REACT_APP_API_URL}/getavailabletime`,
            {
              user_id: user_id,
  ...
  const deleteAvailability = useCallback((event, item, day) => {
    ...
    async function fetchData() {
      ...
      Axios.post(`${process.env.REACT_APP_API_URL}/deleteavailability`, {
