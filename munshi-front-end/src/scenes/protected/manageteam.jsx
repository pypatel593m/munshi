...
const ManageTeam = () => {
  ...
  const createNewTeam = async (e) => {
    await Axios.post(`${process.env.REACT_APP_API_URL}/newteam`, {
      team_id: team_id,
  ...
  const createNewPosition = async (e) => {
    await Axios.post(`${process.env.REACT_APP_API_URL}/newposition`, {
  ...
  const DeleteTeam = useCallback((event, cellValues) => {
    ...
    async function fetchData() {
      Axios.post(`${process.env.REACT_APP_API_URL}/deleteteam`, {
  ...
  const DeletePosition = useCallback((event, cellValues) => {
    async function fetchData() {
      //e.preventDefault();
      Axios.post(`${process.env.REACT_APP_API_URL}/deleteposition`, {
  ...
  useEffect(() => {
    Axios.post(`${process.env.REACT_APP_API_URL}/getteams`, {
      business_id: business.m_business_id,
    })
      .then((response) => {
  ...
  useEffect(() => {
    Axios.post(`${process.env.REACT_APP_API_URL}/getpositions`, {
      business_id: business.m_business_id,
    })
      .then((response) => {
