import { Box, TextField, useTheme, IconButton, Button } from "@mui/material";
...
const ViewTeam = () => {
  ...
  const AddUser = async (e) => {
    e.preventDefault();
    await Axios.post(`${process.env.REACT_APP_API_URL}/adduser`, {
  ...
  useEffect(() => {
    Axios.post(`${process.env.REACT_APP_API_URL}/teammembers`, {
      team_id: team_id,
